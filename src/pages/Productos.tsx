...
const EMPTY: Omit<Producto, 'id'> = {
  ...
  estado: 'activo', unidad: 'Frasco', descripcion: '', imagen: '',
  calidad: 'Original', mililitros: 100, genero: 'Unisex', familia_olfativa: '', talla: 'M', color: 'Negro'
};
...
export function Productos() {
  const { productos, proveedores, addProducto, updateProducto, deleteProducto, configuracion } = useAppData();
  ...
  const exportToCSV = () => {
    const headers = ['Código', 'Nombre', 'Categoría', 'Precio Costo', 'Precio Venta', 'Stock', 'Stock Mínimo', 'Estado'];
