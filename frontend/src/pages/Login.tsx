    ...
    <div className="min-h-screen flex bg-slate-900">
      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative space-y-6 animate-fade-in-up animation-delay-100">
          <div>
            <h2 className="text-4xl font-extrabold text-white leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-linear-to-r from-teal-400 to-emerald-400">Nivel Empresarial</span>
            </h2>
        ...
        <div className="relative animate-fade-in-up animation-delay-300">
          <p className="text-slate-600 text-xs font-medium">© 2025 GestiónPro · Entorno Seguro</p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md relative z-10 animate-fade-in-up">
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/80 border border-slate-100 p-8 transition-all duration-300 hover:shadow-2xl hover:shadow-slate-200">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-teal-500/30 focus:border-teal-500 transition-all text-slate-800"
              ...
              <div>
                <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-2">Contraseña</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full mt-2 flex items-center justify-center gap-2 py-3.5 bg-teal-600 text-white font-bold rounded-xl hover:bg-teal-700 disabled:opacity-70 disabled:hover:bg-teal-600 active:scale-[0.98] transition-all duration-150 shadow-lg shadow-teal-600/25 hover:shadow-xl hover:shadow-teal-600/35 cursor-pointer text-sm"
              >
                {loading ? <Loader2 size={18} className="animate-spin" /> : 'Iniciar Sesión Segura'}
              </button>
            </form>

            <p className="text-center text-[10px] uppercase font-bold tracking-wider text-slate-400 mt-6">
